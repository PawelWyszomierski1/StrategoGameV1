...
public class AlphaBeta {
    ...
    public static int getMoveId(ArrayList<JButton> listOfButtons)
    {
        ...
        for(ArrayList<JButton> element: childs)
        {
            ...
            int minMaxValue = minMax(element, depth,true , point,alpha,beta);
            ...
            if(alpha> beta ) return bestIndex;
    ...
    private static int minMax(ArrayList<JButton> listOfButtons, int searchDepth,boolean isRedPlayerTurn, int points,int alpha, int beta)
    {
        ...
        if(isRedPlayerTurn)
        {
            for(ArrayList<JButton> element: childs)
            {
                ...
                beta  = Math.min(beta,minMax(element, searchDepth-1, false, points-point,alpha,beta));
        ...
        else
        {
            for(ArrayList<JButton> element: childs)
            {
                ...
                alpha = Math.max(alpha,minMax(element, searchDepth-1, true, points+point,alpha,beta));
